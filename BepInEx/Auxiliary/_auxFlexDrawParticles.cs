            ...
            if (m_actor && m_actor.handle)
            {
                ...
                if (m_actor is FlexSoftActor)
                {
                    ...
                    for (int i = 0; i < shapeCount; ++i)
                    {
                        ...
                        //m_particleMaterials[i] = new Material(Nexus.BundleLoader.BundleLoaderPlugin.Instance.GetAssetBundle("flexshaders").LoadAllAssets()[3] as Shader);
                        m_particleMaterials[i] = Nexus.BundleLoader.BundleLoaderPlugin.Instance.GetAssetBundle("flexmaterials").LoadAllAssets()[4] as Material;
                ...
                else
                {
                    ...
                    //m_particleMaterials[0] = new Material(Nexus.BundleLoader.BundleLoaderPlugin.Instance.GetAssetBundle("flexshaders").LoadAllAssets()[3] as Shader);
                    m_particleMaterials[0] = Nexus.BundleLoader.BundleLoaderPlugin.Instance.GetAssetBundle("flexmaterials").LoadAllAssets()[4] as Material;
